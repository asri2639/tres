  ...
  useEffect(() => {
    try {
          ...
          if ((a = e && !(e in b.c)))
            if (0 >= c.offsetWidth && 0 >= c.offsetHeight) a = !1;
              ...
              b.b.hasOwnProperty(f)
                ? (a = !1)
                : ((b.b[f] = !0), (a = a <= b.g.height && d <= b.g.width));
            }
          ...
          for (var d = 0; (a = c[d]); ++d) {
            ...
            e &&
              ((!(e in b) &&
                ...
                0 < a.naturalWidth &&
                0 < a.naturalHeight) ||
                (e in b && a.width >= b[e].o && a.height >= b[e].m)) &&
              (b[e] = {
                rw: a.width,
                rh: a.height,
                ow: a.naturalWidth,
      ...
      pagespeed.CriticalImages.Run(
        ...
        'http://www.etvbharat.com/src/app/components/staticpages/contactus.html',
        '27I5RNcBrb',
        true,
        false,
        'RO1B1Jj1xVk'
  ...
  return (
    ...
    >
      <div className="static-content ">
        <h1 className="page-header my-3 text-xl font-bold">CONTACT US</h1>
        <div className="center flex  w-full justify-center flex-col items-center">
          <div className="w-80  flex  w-full justify-center flex-col items-center">
            ...
            <h2> A Division of Ushodaya Enterprises Pvt. Ltd.,</h2>
            <h2> Ramoji Film City, R.R. Dist.,</h2>
            <h2> Hyderabad-501512 – Telangana -INDIA.</h2>
            <h2>
              Contact:{' '}
              <a className="text-blue-500" href="tel:08415246555">
                08415 246555
              </a>
            </h2>
          </div>
